 ...
 * TODO: Do we want a TestObserver response for successfully sent messages? 
 * 			(nothing in protocol for this)
...
public class ChatWindowPrivateChatTests {
	...
	//no response to success for send private message so approached it like this
	@Test
