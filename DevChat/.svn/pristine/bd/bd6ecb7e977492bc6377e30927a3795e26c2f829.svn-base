...
/**
 * This class contains methods which the database class used in the server must implement.
 * The methods allow the server to request information from the database.
 */
