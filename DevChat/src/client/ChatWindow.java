 ...
 *  can be called
 */
public class ChatWindow extends Observable implements ChatWindowGUIProtocol {
	...
	public void addTeamMember(String username) {
		int messageID = incrementMessageID();
		out.add(new Message(Message.Status.ADD_USER, threadID, messageID, username, chat));
